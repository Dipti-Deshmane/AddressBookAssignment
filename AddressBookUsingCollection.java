...
public class AddressBookUsingCollection {
       public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        do {
            ...
            System.out.println("5. Save Address Books to file");
            System.out.println("6. Load Address Books from file");
            ...
            switch (choice) {
                ...
                case 5:
                    try {
                        addressBookSystem.saveAddressBooksToFile();
                        System.out.println("Address Books saved to file.\n");
                    } catch (IOException e) {
                        System.out.println("Error occurred while saving Address Books to file: " + e.getMessage());
                    }
                    break;
                case 6:
                    try {
                        addressBookSystem.loadAddressBooksFromFile();
                        System.out.println("Address Books loaded from file.\n");
                    } catch (IOException e) {
                        System.out.println("Error occurred while loading Address Books from file: " + e.getMessage());
                    }
                    break;
                case 0:
